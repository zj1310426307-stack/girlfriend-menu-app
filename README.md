...
│   ├── alembic/versions/        # V2.0～V2.2 数据库版本
│   ├── seed.py                  # 19 道测试菜品
│   ├── storage.py               # 本地图片存储
...
2026-08-09 本地验证：后端 `7 passed`、V2.0 → V2.2 迁移在全新 SQLite 数据库执行成功、小程序生产构建成功。
...
5. 进入“我们”查看默契值、积分明细、共同记录和成就，并从低强调入口进入“小厨房管理”。
