...
V2.8 RC 已完成设备身份、订单归属、12 小时管理令牌、订单状态审计和分页、生产存储抽象、实时重连加固、环境配置集中化及备份恢复工具；当前微信体验版在此基础上冻结为 `2.9.0`，工作区已进入 `2.9.1` 游戏体验开发版。真实能力与未验证边界见 [能力矩阵](docs/CAPABILITY_MATRIX.md)。
