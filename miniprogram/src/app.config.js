export default defineAppConfig({
  pages: [
    ...
    "pages/games/index",
    "pages/games/gomoku/index",
    "pages/games/flight/index",
    "pages/games/landlord/index",
    "pages/games/animal/index",
    "pages/games/chess/index",
    "pages/games/ranking/index",
    "pages/games/ai/index",
    "pages/couple/index",
    "pages/couple/score",
