...
const GAMES = [
  { title: "今晚转盘", desc: "自己写选项，把纠结交给一点好运", mark: "转", url: "/pages/wheel/index", tone: "sage" },
  { title: "3D 大话骰", desc: "酒吧桌面、上滑开盅和 AI 对局", mark: "骰", url: "/pages/dice/index", tone: "dark" },
  { title: "和女朋友实时对战", desc: "创建双人房间，实时叫骰和计分", mark: "双", url: "/pages/dice-online/index", tone: "coral" }
];
  ...
  return (
    <View className="page v2-games-page">
      ...
      <View className="v2-game-list">
        {GAMES.map((game) => (
          <View key={game.url} className={`v2-game-card ${game.tone}`} onClick={() => Taro.navigateTo({ url: game.url })}>
